...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        self._train_multi_dataloader :DataLoader = None
        self._val_multi_dataloader :DataLoader = None
        self._ema :nn.Module = None 
        self._scaler :GradScaler = None 
        self._train_dataset :Dataset = None 
        self._val_dataset :Dataset = None
        self._train_multi_dataset :Dataset = None
        self._val_multi_dataset :Dataset = None
        self._collate_fn :Callable = None
        self._evaluator :Callable[[nn.Module, DataLoader, str], ] = None
        self._multi_evaluator :Callable[[nn.Module, DataLoader, str], ] = None
        ...
        self._train_multi_batch_size :int = None
        self._val_multi_batch_size :int = None
        self._train_shuffle: bool = None  
        self._val_shuffle: bool = None 
        self._train_multi_shuffle: bool = None
        self._val_multi_shuffle: bool = None
        # self._train_num_refs :int = None
        # self._val_num_refs :int = None
    ...
    @property
    def train_multi_dataloader(self) -> DataLoader:
        if self._train_multi_dataloader is None and self.train_multi_dataset is not None:
            loader = DataLoader(self.train_multi_dataset, 
                                batch_size=self.train_multi_batch_size, 
                                num_workers=self.num_workers, 
                                collate_fn=self.collate_fn,
                                shuffle=self.train_multi_shuffle, 
                                )
            # is this necessary?
            loader.shuffle = self.train_multi_shuffle
            self._train_multi_dataloader = loader

        return self._train_multi_dataloader

    @train_multi_dataloader.setter
    def train_multi_dataloader(self, loader):
        self._train_multi_dataloader = loader 

    @property
    def val_multi_dataloader(self) -> DataLoader:
        if self._val_multi_dataloader is None and self.val_multi_dataset is not None:
            loader = DataLoader(self.val_multi_dataset, 
                                batch_size=self.val_batch_size, 
                                num_workers=self.num_workers, 
                                collate_fn=self.collate_fn,
                                shuffle=self.val_multi_shuffle, )
            # is this necessary?
            loader.shuffle = self.val_multi_shuffle
            self._val_multi_dataloader = loader

        return self._val_multi_dataloader

    @val_multi_dataloader.setter
    def val_multi_dataloader(self, loader):
        self._val_multi_dataloader = loader
    ...
    @property
    def train_multi_shuffle(self) -> bool:
        if self._train_multi_shuffle is None:
            print('warning: set default train_multi_shuffle=True')
            return True
        return self._train_multi_shuffle

    @train_multi_shuffle.setter
    def train_multi_shuffle(self, shuffle):
        assert isinstance(shuffle, bool), 'shuffle must be bool'
        self._train_multi_shuffle = shuffle

    @property
    def val_multi_shuffle(self) -> bool:
        if self._val_multi_shuffle is None:
            print('warning: set default val_multi_shuffle=False')
            return False
        return self._val_multi_shuffle

    @val_multi_shuffle.setter
    def val_multi_shuffle(self, shuffle):
        assert isinstance(shuffle, bool), 'shuffle must be bool'
        self._val_multi_shuffle = shuffle
    ...
    @property
    def train_multi_batch_size(self) -> int:
        if self._train_multi_batch_size is None and isinstance(self.batch_size, int):
            print(f'warning: set train_multi_batch_size=batch_size={self.batch_size}')
            return self.batch_size
        return self._train_multi_batch_size

    @train_multi_batch_size.setter
    def train_multi_batch_size(self, batch_size):
        assert isinstance(batch_size, int), 'batch_size must be int'
        self._train_multi_batch_size = batch_size
    
    @property
    def val_multi_batch_size(self) -> int:
        if self._val_multi_batch_size is None:
            print(f'warning: set val_multi_batch_size=batch_size={self.batch_size}')
            return self.batch_size
        return self._val_multi_batch_size

    @val_multi_batch_size.setter
    def val_multi_batch_size(self, batch_size):
        assert isinstance(batch_size, int), 'batch_size must be int'
        self._val_multi_batch_size = batch_size

    # TODO
    # @property
    # def train_num_refs(self) -> int:
    #     if self._train_num_refs is None:
    #         print(f'warning: set train_num_refs=num_refs={self.num_refs}')
    #         return self.train_num_refs
    #     return self._train_num_refs

    # @train_num_refs.setter
    # def train_num_refs(self, num_refs):
    #     assert isinstance(num_refs, int), 'train_num_refs must be int'
    #     self._train_num_refs = num_refs

    # @property
    # def val_num_refs(self) -> int:
    #     if self._val_num_refs is None:
    #         print(f'warning: set val_num_refs=num_refs={self.num_refs}')
    #         return self.num_refs
    #     return self._val_num_refs

    # @val_num_refs.setter
    # def val_num_refs(self, num_refs):
    #     assert isinstance(num_refs, int), 'num_refs must be int'
    #     self._val_num_refs = num_refs
    ...
    @property
    def train_multi_dataset(self) -> Dataset:
        return self._train_multi_dataset

    @train_multi_dataset.setter
    def train_multi_dataset(self, dataset):
        assert isinstance(dataset, Dataset), f'{type(dataset)} must be Dataset'
        self._train_multi_dataset = dataset
    
    @property
    def val_multi_dataset(self) -> Dataset:
        return self._val_multi_dataset

    @val_multi_dataset.setter
    def val_multi_dataset(self, dataset):
        assert isinstance(dataset, Dataset), f'{type(dataset)} must be Dataset'
        self._val_multi_dataset = dataset
    ...
    @property
    def multi_evaluator(self) -> Callable:
        return self._multi_evaluator

    @multi_evaluator.setter
    def evaluator(self, fn):
        assert isinstance(fn, Callable), f'{type(fn)} must be Callable'
        self._multi_evaluator = fn
