...
class BaseSolver(object):
    ...
    def train(self, ):
        ...
        if not self.cfg.yaml_cfg['multi_frame']:
            ...
            # TODO: multi-dataloader support
            self.train_dataloader = dist_utils.warp_loader(self.cfg.train_multi_dataloader, \
                shuffle=self.cfg.train_multi_dataloader.shuffle)
            self.val_dataloader = dist_utils.warp_loader(self.cfg.val_multi_dataloader, \
                shuffle=self.cfg.val_multi_dataloader.shuffle)
            self.evaluator = self.cfg.multi_evaluator
